---
title: So you want to set up an Indigenous data catalogue?
description: A practical guide to planning, establishing, publishing and operating an Indigenous data catalogue.
---
...
| **Catalogued resource or item** | A dataset, project, collection, service, publication, record set or other thing described by a catalogue | The parties connected to that resource | A single catalogue record with an identifier, description, roles, rights and access information |
...
“Setting up a catalogue” can mean establishing a new catalogue at one level, contributing a project or collection to a catalogue at another level, or adding a catalogue to a catalogue of catalogues. Clarify both the **catalogue level** and the **technical arrangement** early.
...
- whether smaller project catalogues remain distinct or are represented as collections within the node catalogue.
...
This checklist is aligned, where practical, with the language and intent of KurrawongAI's [Data Maturity Assessment (DMMM) tool](https://tools.kurrawong.ai/dmmm). The DMMM is an introductory organisational self-assessment based on three broad domains—**Data Design**, **Data Governance** and **Data Operations**—and considers people, tools and technology. This checklist applies those domains specifically to establishing and operating an Indigenous data catalogue.

The DMMM describes five levels of capability:

1. **Initial** — practices are ad hoc, inconsistent or not formally known;
2. **Repeatable** — practices are informally understood but not adequately documented;
3. **Documented/Defined** — practices are documented and defined within the organisation;
4. **Monitored/Managed** — practices are monitored or measured against defined expectations;
5. **Optimised** — practices use defined metrics and proactive continuous improvement, with appropriate automation or streamlining.

A checked item below means the capability is present; it does not, by itself, establish its maturity. For important items, record whether the practice is merely repeatable, formally defined, monitored or continuously improved. Complete the DMMM separately when a broader view of organisational data-management maturity is needed. A catalogue implementation may expose organisational gaps that the catalogue project cannot resolve by itself.

### Data Design

#### Data modelling and metadata

- [ ] Metadata requirements are documented, maintained and aligned with the current IDN Catalogue Profile and other applicable standards; deviations are documented.
- [ ] The catalogue's level is explicit: IDN/network, node/organisation, or project/collection.
...
- [ ] Conceptual and logical models reflect the catalogue's purpose, resources, relationships and organisational processes.
- [ ] Descriptive information, including mappings, data dictionaries and reference vocabularies, is available to and understood by people with catalogue responsibilities.
- [ ] Metadata can capture and report relevant Indigenous data considerations, including roles, access conditions, provenance and approved notices or labels.
- [ ] Stable HTTP/HTTPS PID IRIs are planned and non-HTTP catalogue identifiers follow the IDN Catalogue Profile.
- [ ] Relevant data-resource roles use the IDN Role Codes vocabulary.
- [ ] Source mappings, transformation rules and provenance are documented.
- [ ] The authoritative metadata source is identified across every catalogue level.
- [ ] Uncertainty and source limitations are preserved rather than silently normalised.

#### Data architecture

- [ ] The catalogue architecture addresses current and foreseeable business, governance and user requirements.
- [ ] Existing, shared and separate-instance options were considered before selecting an architecture.
- [ ] Project, node and IDN-level aggregation or synchronisation is documented, including corrections and withdrawals.
- [ ] Development, staging and production arrangements are appropriate to the service's scale and risk.
- [ ] RDF database, Prez, Prez UI, identifier and integration components are fit for purpose.
- [ ] The data ecosystem, component boundaries, data flows and dependencies are documented and reviewed as part of service planning.
- [ ] Domains, DNS, TLS and persistent identifier resolution are controlled by appropriate organisational accounts.
- [ ] Export, migration and exit arrangements reduce dependency on a particular provider or implementation.

#### Data quality

- [ ] Catalogue data-quality measures are defined and understood by the people whose work affects them.
- [ ] Quality measures cover at least identifier resolution, required metadata, current contacts, vocabulary use, provenance, profile conformance, broken links and review status.
- [ ] RDF syntax and SHACL/profile validation are repeatable and produce actionable results.
- [ ] Cultural, rights, privacy and content review is treated as essential to quality, not as an optional technical check.
- [ ] Data-quality results and exceptions are incorporated into regular, reportable review cycles.
- [ ] Representative users have tested discovery, interpretation, access information, contacts and correction pathways.

### Data Governance

#### Organisational data strategy

- [ ] The catalogue's purpose, intended benefit, scope, intended users and beneficiaries are documented.
- [ ] The catalogue supports an agreed organisational or network data strategy, Indigenous data governance objective or service plan.
- [ ] Business plans and roadmaps identify the work required to establish and sustain the catalogue.
- [ ] Success measures include community benefit, trust, usability, safety, metadata quality and sustainability—not only record counts or page views.
- [ ] Establishment and ongoing budgets provide adequate support for governance, stewardship, engagement, technical operation and improvement.
- [ ] Self-managed, assisted or managed delivery has been selected deliberately and reviewed against organisational capability.

#### Governance structure

- [ ] A formal catalogue governance structure is connected to the organisation's broader governance arrangements.
- [ ] An accountable organisational sponsor and catalogue service owner are named.
- [ ] Indigenous governance, leadership and participation arrangements are defined for the catalogue's scope.
- [ ] Owners, rights holders, custodians, subject agents, relevant representatives and stakeholders can be identified.
- [ ] Individual governance, stewardship, publication, technical and support roles are defined and understood.
- [ ] Publication authority and escalation authority are documented.
- [ ] Guidance and feedback can move in both directions between contributors, communities, operational teams, leadership and governance bodies.
- [ ] Decision and audit information has an appropriate, controlled home.

#### Data policy

- [ ] Catalogue policies and procedures reflect broader organisational strategies, agreements and applicable requirements.
- [ ] Policies provide practical guidance on individual responsibilities for metadata, review, approval, access, security, correction and maintenance.
- [ ] Policies specifically address Indigenous data considerations relevant to the catalogue.
- [ ] The distinction between public metadata and access to the described data is explicit.
- [ ] Access conditions, rights information and contacts are clear and consistently applied.
- [ ] Correction, dispute, urgent suppression, takedown, withdrawal and appeal pathways are documented.
- [ ] Policy responsibilities are connected to named accountable roles and review cycles.

#### Data culture

- [ ] Catalogue governance, policies and procedures are understood by contributors, reviewers, operators and leaders.
- [ ] Leadership proactively supports Indigenous data governance and responsible catalogue practice.
- [ ] People are encouraged and able to raise quality, cultural governance, rights, privacy, security and usability concerns.
- [ ] Training, induction and handover reinforce data-management responsibilities rather than relying on informal knowledge.
- [ ] Review findings, user feedback and incidents result in learning and improvement.
...
- [ ] Intended catalogue users, uses and data products are documented and understood.
- [ ] Included and excluded resources are defined, and the approved level of description is clear.
- [ ] Principles for Indigenous Data Sovereignty are reflected in discovery, access, use and decision-making arrangements.
- [ ] Security of information meets organisational, community, industry and legal requirements.
- [ ] Restricted or sensitive information has been checked across pages, APIs, downloads, source repositories and logs.
- [ ] Public help explains what catalogue inclusion means, what it does not mean and how access may be requested.
- [ ] Public contact, correction and concern-reporting pathways are available and tested.
- [ ] Approved catalogue metadata can be interpreted and used with confidence because its context, provenance, quality and limitations are visible.

#### Roles and responsibilities

- [ ] Data-management and catalogue responsibilities, individual allocations and expectations are documented and understood.
- [ ] Ongoing metadata stewardship and technical operation are funded and assigned.
- [ ] People have, or can obtain, the skills and expertise needed for their assigned roles.
- [ ] Workload allocations provide realistic time for governance, engagement, metadata maintenance, support and technical operation.
- [ ] Catalogue assets, systems, records and review obligations are connected to accountable functional roles.
- [ ] Governance and service owners have approved launch and accept ongoing responsibilities.
- [ ] Support, escalation, incident, exit and handover arrangements are documented.

#### Tools and operational practice

- [ ] Tools that affect catalogue data and data management are fit for purpose and reviewed regularly.
- [ ] Tool selection is based on business, governance, contributor and user requirements—not solely technical preference.
- [ ] Documentation, training and support information are appropriate to users' needs and readily available.
- [ ] Administrative access and secrets are secured and reviewed when staff or providers change.
- [ ] Monitoring, logging and incident-response arrangements are active and assigned.
- [ ] Backups and restoration have been tested against defined expectations.
- [ ] Upgrade, rollback and release-record processes are documented and exercised.
- [ ] A controlled initial release has been considered and publication occurs only after governance and technical approval.
- [ ] Record, policy, infrastructure and dependency review schedules are assigned.
- [ ] Metrics, findings and feedback are used to monitor the service and prioritise continuous improvement.
...
- [KurrawongAI Data Maturity Assessment (DMMM)](https://tools.kurrawong.ai/dmmm)
