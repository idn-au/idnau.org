...
image: /img/unsplash/joeyy-lee-Y04q5UQrRQM-unsplash.jpg
---
...
The Indigenous Data Commons, built by the :GlossaryCard{content="Indigenous Data Network" iri="https://linked.data.gov.au/org/idn"}, is a national, shared digital infrastructure that advances Indigenous authority, governance, and benefit in the management of Indigenous data. It provides a trusted environment where data about Aboriginal and Torres Strait Islander peoples are governed by Indigenous owners and used in ways that align with Indigenous priorities, rights, and wellbeing. Grounded in the recognition of Indigenous sovereignty, the Indigenous Data Commons establishes a nationally coherent and ethical approach to Indigenous data governance across research, policy, service delivery, and community contexts. 
...
## Our Logo
© Marcus Lee Design Pty Ltd 2026 Concept Design
The Indigenous Data Commons logo, utilises graphic elements from the Indigenous Studies Unit logo, including concentric circular formations symbolising the gathering of Indigenous data. The colours used in the logo reflect the colours of the Aboriginal and Torres Strait Islander flags, and represent Country (yellow), Water (blue), Community (red) and Gathering (green).The three surrounding coloured shapes represent the finding-Yellow, recording-Red and describing-Green process of the Indigenous Data Commons
