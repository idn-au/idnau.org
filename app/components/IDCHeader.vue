...
<template>
	<header :class="`top-nav sticky top-0 flex flex-row items-center p-4 gap-2 z-50 transition-colors flex-wrap ${props.allowToggleNav ? 'bg-transparent' : 'bg-background'}`">
